 ...
 *
 */
public class StorageApiFactory implements Supplier<StorageApi> {
   ...
   public StorageApi get() {
      ...
      try {
         ...
         return new StorageApi(storageApiUrl);
   ...
   public static class Binder extends AbstractBinder {
      ...
      protected void configure() {
         bindFactory(StorageApiFactory.class).to(StorageApi.class).in(Singleton.class);
      }
   }
}